...
Aplicación de escritorio para **visualizar y registrar la telemetría** del proyecto FOLLOW THE CATAPUM. Recibe datos enviados por un ESP32 a través del puerto serie, muestra las lecturas en tiempo real y permite guardarlas para analizarlas después.
